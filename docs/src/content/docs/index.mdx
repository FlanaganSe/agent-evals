...
hero:
  ...
  actions:
    - text: Get Started
      ...
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/your-org/agent-evals
      variant: minimal
      icon: external
---
...
<CardGrid stagger>
  ...
  <Card title="18 Built-in Graders" icon="approve-check">
    From exact-match to semantic similarity. Compose graders, weight scores, and set quality gates — all deterministic, no LLM needed.
  </Card>
